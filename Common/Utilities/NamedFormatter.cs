...
namespace CSM.Common.Utilities
{
    public static class NamedFormatter
    {
        ...
        public static string NamedFormat(this string format, object @object)
        {
            if (format == null)
            {
        ...
        private static Descriptor[] GetDescriptors(string format)
        {
            ...
            var descriptorBuilder = new StringBuilder(format.Length);
        ...
        private class Descriptor : IEquatable<Descriptor>
        {
            public Descriptor(string descriptorValue)
            {
                ...
                if (descriptorValue.Trim().Length == 0)
                {
                    throw new ArgumentException("Empty descriptor not allowed.", "descriptorValue");
                }
